...
public class SomeFakeJSON {
    ...
    private static ArrayList<Earthquake> extractEarthquakesFromJSON(String jsonResponse) {
        ...
        try {
            ...
            JSONArray featuresArray = sampleJSON.getJSONArray("features");
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                earthquakes.add(new Earthquake(magnitudeOutput, place, dateToDisplay,timeToDisplay,url));
